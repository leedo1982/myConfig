...
function pasteboardToClipboard(item)
    print("---pasteboardToClipboard--item:", item,"---")
...
populateMenu = function(key)
    ...
    if (key == nil) then
        key = hs.keycodes.map['f19']
        key.alt = true
    end
    print("---populateMenu--key:",key,"---");
...
--hs.hotkey.bind({}, 'f19', populateMenu)
